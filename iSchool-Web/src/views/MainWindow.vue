...
<template>
  <div style="position: fixed; z-index: 5; width: 100%; margin-top: -0.4%; left: 0">
    <el-menu :default-active="$route.path" mode="horizontal" :ellipsis="false" :router="true">
      <!-- logo -->
      <div style="display: flex; margin: 10px 10px 5px; justify-content: center; align-items: center">
        <img style="height: 100%" src="/public/img/code.png" />
        <div style="font-size: 30px; padding: 5px 10px; font-weight: 700; line-height: 160%">
          智搜通
        </div>
      </div>
  ...
  <div class="footer">
    ...
    <div class="text">
      <div>
        ...
        >开展任何盈利活动，如果您发现本系统不支持您的学校，请点击左侧去Github提出issue
      </div>
